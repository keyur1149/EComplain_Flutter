...
class Profcomplain extends StatefulWidget {
  const Profcomplain({Key? key}) : super(key: key);

  @override
  State<Profcomplain> createState() => _ProfcomplainState();
}

class _ProfcomplainState extends State<Profcomplain> {
  List _Complains=[];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0.5,
        title: Text("Professor Complaint "),
        backgroundColor: mainColor,
        actions: [
