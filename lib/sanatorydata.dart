...
class Sanatorycomplain extends StatefulWidget {
  const Sanatorycomplain({Key? key}) : super(key: key);

  @override
  State<Sanatorycomplain> createState() => _SanatorycomplainState();
}

class _SanatorycomplainState extends State<Sanatorycomplain> {
  @override
    ...
    fetchcomplains() async{
      ...
      setState(() {
        for(int i=0;i<qn.docs.length;i++){
          if(qn.docs[i]["type"]=="Sanatory" || qn.docs[i]["type"]=="sanatory") {
            _Complains.add({
